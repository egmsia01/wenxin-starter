...
@Lazy
@Service
public class RWKV4WorldClient extends FullClient {
    ...
    private static Map<String, Deque<Message>> RWKV_4_WORLD_MESSAGES_HISTORY_MAP = new ConcurrentHashMap<>();
    ...
    private String getCustomURL() {
        return wenXinProperties.getRWKV4_World_URL();
    }
