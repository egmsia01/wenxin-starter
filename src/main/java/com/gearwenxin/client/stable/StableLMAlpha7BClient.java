 ...
 * @date 2023/8/5
 */
public abstract class StableLMAlpha7BClient extends DefaultParamsClient {
    ...
    private static Map<String, Queue<Message>> STABLELM_ALPHA_7B_MESSAGES_HISTORY_MAP = new ConcurrentHashMap<>();
    ...
    public Map<String, Queue<Message>> getMessageHistoryMap() {
        return STABLELM_ALPHA_7B_MESSAGES_HISTORY_MAP;
    }

    @Override
    public void initMessageHistoryMap(Map<String, Queue<Message>> map) {
        STABLELM_ALPHA_7B_MESSAGES_HISTORY_MAP = map;
    }
